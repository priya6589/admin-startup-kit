...
function applyTheme(key,mode) {
  ...
  applyTheme('dark-mode',$dark_mode_checkbox);
...
// navbar
  ...
  applyTheme('layout-navbar-fixed',$header_fixed_checkbox);
  ...
  applyTheme('dropdown-legacy',$dropdown_legacy_offset_checkbox);
  ...
  applyTheme('border-bottom-0',$no_border_checkbox);
  ...
  applyTheme('sidebar-collapse',$sidebar_collapsed_checkbox);
  ...
  applyTheme('layout-fixed',$sidebar_fixed_checkbox);
